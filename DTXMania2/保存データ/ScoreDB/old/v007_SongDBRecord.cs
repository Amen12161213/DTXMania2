...
namespace DTXMania2.old.SongDBRecord
{
    class v007_ScoreDBRecord
    {
        ...
        public v007_ScoreDBRecord(SqliteDataReader reader)
            : this()
        {
            this.UpdateFrom(reader);
        }

        public v007_ScoreDBRecord(VariablePath 譜面ファイルの絶対パス, ユーザ設定 userConfig)
        {
